...
public class BasicfamilyPackageImpl extends EPackageImpl implements BasicfamilyPackage {
	...
	public static BasicfamilyPackage init() {
		...
		BasicfamilyPackageImpl theBasicfamilyPackage = (BasicfamilyPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof BasicfamilyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
